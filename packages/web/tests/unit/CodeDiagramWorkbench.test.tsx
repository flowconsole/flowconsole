...
import { CodeDiagramWorkbench } from '../../components/Workbench/CodeDiagramWorkbench';
...
vi.mock('../../languages/typescript/evaluateDiagramCode', () => ({
...
vi.mock('../../components/VerticalSplit', () => {
