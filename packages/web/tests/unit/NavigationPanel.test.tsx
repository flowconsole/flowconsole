...
vi.mock('../../hooks/hooks', async () => {
  const actual = await vi.importActual<typeof import('../../components/NavigationPanel')>(
    '../../hooks/hooks'
  );
  return {
    ...actual,
...
vi.mock('../../components/NavigationPanel/NavigationPanelControls', () => ({
  NavigationPanelControls: () => <div data-testid="controls" />,
  default: () => <div data-testid="controls" />,
}));

vi.mock('../../components/NavigationPanel/NavigationPanelDropdown', () => ({
...
vi.mock('../../components/NavigationPanel/SearchOverlay', () => ({
  default: () => null,
}));
